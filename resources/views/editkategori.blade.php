...
@section('container')
    <h3 class="h3"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
        ...
        </svg> Edit Kategori Produk</h3>
    <div class="col-md-6">
        <div class="card border-primary">
            <div class="card-body">
                <form action="/kategoriproduk/{{ $editkategori->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <h6><label for="kategori">Nama Kategori</label></h6>
                        <input type="text" name="namakategori" class="form-control" placeholder="" autocomplete="off"
                            value="{{ $editkategori->nama_category }}">
                    </div>
                    <div class="form-group mt-1">
                        <a href="/kategoriproduk" class="btn btn-danger mt-3"><svg xmlns="http://www.w3.org/2000/svg"
