...
@section('container')
    ...
    <a href="/produk/create"><button class="btn btn-primary mt-3 mb-4" type="submit"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <table class="table table-responsiv table-bordered">
        ...
        <tr>
            ...
            <td>{{ $produknya->nama_products }}</td>
            <td>{{ $produknya->harga }}</td>
            <td>{{ $produknya->deskripsi }}</td>
            <td>{{ $produknya->stok }}</td>
            <td>{{ $produknya->produk_kategori->nama_category }}</td>
            <td class="text-center">
                <a href="/produk/{{ $produknya->id }}/edit" class="btn btn-warning btn-sm"><svg
                ...
                <form action="/produk/{{ $produknya->id }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
                ...
                <a href="/produk/{{ $produknya->id }}" class='btn btn-primary'>detail</a>
            </td>
        </tr>
        @endforeach
    </table>
